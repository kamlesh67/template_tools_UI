...
`;
  ...
  const toolEmailTemplate = function (values, isViewer = false) {
    ...
    <div class="speaker-img" style="position: relative; z-index: 1; overflow: hidden; border-radius: 20rem 0 20rem 20rem; border: 1rem solid #ED7767; top: -16px; right: -16px; line-height:0">
