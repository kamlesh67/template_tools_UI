...
`;
  ...
  const toolEmailTemplate = function (values, isViewer = false) {
    ...
    }" style="width: 115px; margin-bottom:0px; margin-left: auto; margin-right: auto; height: 190px; padding-bottom: 10rem; overflow: hidden; border-radius: 8px; display: block; background-color:${
