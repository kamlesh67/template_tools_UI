...
const boothList = function (booths) {
  ...
  booths.map((booth, i) => {
    if (i <= 1) {
      bts += ` <div style="height: 30px; width: 50px;overflow: hidden;border-radius: 4px;display: flex;margin-right: 6px;justify-content: center;padding: 2px;border: 1px solid #E0E0E0;background-color: #ffffff;">
...
const defaultBooth = `
            <div style="height: 30px; width: 50px;overflow: hidden;border-radius: 4px;display: flex;margin-right: 6px;justify-content: center;padding: 2px;border: 1px solid #E0E0E0;background-color: #ffffff;"> 
...
const toolEmailTemplate = function (values, isViewer = false) {
  return `
  <div style="position:relative;background-color:${values.sessionCardBGColor};margin-bottom: 15px;height: auto;padding: 14px; background-color: #fff;border-radius: 8px;" >
  <div class="session-card-body">
    ...
    <p style="color:${values.sessionDescriptionColor};font-size: 12px;font-weight: 400;">
      ${values.description ? values.description : 'session description'}
    </p>
