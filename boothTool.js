...
const toolEmailTemplate = function (values, isViewer = false) {
  ...
  {
  return `
  <div boothId="${values?.boothLibrary?.selected?.id}" style="position:relative;background-color:${values.boothBGColor};margin-bottom: 15px;padding:18px 10px;border-radius: 8px; border: 1px solid #d3d3d3;">
